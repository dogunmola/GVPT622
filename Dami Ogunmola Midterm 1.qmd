...
::: callout-note
You need to find the proportion within groups of your IV.
:::
...
::: callout-note
You are comparing proportions within the DV, which doesn't address the hypothesis.
:::
...
::: callout-note
It's the range between 6.27% and 46.12%.
:::
