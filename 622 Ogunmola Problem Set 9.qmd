...
library(poliscidata)
library(readr)
censusAggregate_1 <- read_csv("Downloads/censusAggregate-1.csv")
...
On average, non-Southern states were associated with a 5.546 point higher voter turnout rate than Southern states. This is statistically significant with a p-value \<0.001. The 95% confidence interval is \[3.978, 7.113\]. As the confidence interval does not include 0, this also provides support for the statistical significance of the findings.

Furthermore, states with election day registration available were associated with 5.792 point increase in voter turnout than states without election day registration, on average. This is statistically significant with a p-value \<0.001. The 95% confidence interval is \[3.715, 7.870\]. As the 95% confidence does not contain 0, that also supports the statistical significance of the findings.

A one percentage point increase in the percentage of the population in a state that graduated high school was associated with a 0.101 point increase in voter turnout, on average. This is statistically significant at a p-value of 0.006. Furthermore, the confidence interval, \[0.030, 0.172\], does not contain 0, supporting the statistical significance of the findings.
