...
A t-statistic of 2.50 corresponds to .9938 on the z-table and a p-value of .0062. As the commonly-used minimum p-value in the social sciences is .05, the p-value of .0062 suggests the statistical significance of the sample mean compared to the null hypothesis. Specifically, there is a .62% chance that an experiment or study would have resulted in the sample mean if the null hypothesis was true and there was no difference in the population between the two groups.
...
-1.15 corresponds to a p-value of .1251 on the z table. Thus, the one-tailed p-value is .1251. This means that there is 12.51% chance of observing the sample proportion if the null hypothesis were true. This also means that based on social science standards of a .05 p-value that the results are not statistically significant.

### Part E

**Do the data support my hypothesis? Why, or why not?**

The data does not support your hypothesis. Calculating a p-value is a critical way to assess statistical significance and whether data supports the alternative hypothesis.

As the p-value (.1251) is greater than 0.05 (the most commonly-used p-value in the social sciences), we must fail to reject the null hypothesis.
...
The null hypothesis is that there is no difference in the fertility rates of countries with high or low female literacy rates. Thus, if the null hypothesis were true, there would be no significant difference in the mean fertility rates between countries with higher and lower literacy rates. The boxplot below, with no discernible difference in the mean fertility rates of countries based on their literacy rate, demonstrates what the mean fertility rate of countries with low and high literacy rates would look like in the null world.
